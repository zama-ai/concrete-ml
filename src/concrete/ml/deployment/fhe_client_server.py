...
class FHEModelClient:
    ...
    def get_serialized_evaluation_keys(self) -> Union[bytes, Tuple[bytes, Optional[bytes]]]:
        ...
        if self.model.ciphertext_format == CiphertextFormat.TFHE_RS:
            ...
            return self.client.evaluation_keys.serialize(), self.get_tfhers_secret_key()

        return self.client.evaluation_keys.serialize(), None
