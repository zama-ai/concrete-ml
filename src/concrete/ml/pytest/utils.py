...
from .torch_models import QuantCustomModel, TinyQATCNN
...
def train_brevitas_network_tinymnist(is_cnn, qat_bits, signed, narrow, pot_scaling):
    ...
    while not trained_ok:
        ...
        if is_cnn:
            ...
            net = QuantCustomModel(
                64, 10, 100, qat_bits, act_quant, weight_quant, bias_quant
            )  # type: ignore
