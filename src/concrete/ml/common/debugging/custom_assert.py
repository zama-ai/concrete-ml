...
def _custom_assert(condition: bool, on_error_msg: str = ""):
    ...
    Raises:
        AssertionError: Raises an error if condition is False
...
def assert_true(condition: bool, on_error_msg: str = ""):
    ...
    """
    _custom_assert(condition, on_error_msg)
...
def assert_false(condition: bool, on_error_msg: str = ""):
    ...
    """
    _custom_assert(not condition, on_error_msg)
...
def assert_not_reached(on_error_msg: str):
    ...
    """
    _custom_assert(False, on_error_msg)
