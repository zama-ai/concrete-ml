...
if "KEY_FOR_COMMUNITY_DISCOURSE" not in os.environ:
    raise Exception("Missing required environment variable 'KEY_FOR_COMMUNITY_DISCOURSE'. Please set this API key in your environment to access community discourse data.")
