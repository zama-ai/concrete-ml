...
CN_VERSION_SPEC_FOR_RC="concrete-numpy[full]==0.6.0-rc7"
...
supported_ops:
	poetry run python script/doc_utils/gen_supported_ops.py docs/compilation_onnx.md
	"$(MAKE)" mdformat

.PHONY: check_supported_ops # Check supported ops (for the doc)
check_supported_ops:
	poetry run python script/doc_utils/gen_supported_ops.py docs/compilation_onnx.md --check
