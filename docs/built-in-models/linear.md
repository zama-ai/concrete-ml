...
![Sklearn model decision boundaries](../.gitbook/assets/logistic_regression_clear.png) ![FHE model decision boundaries](../.gitbook/assets/logistic_regression_fhe.png)
