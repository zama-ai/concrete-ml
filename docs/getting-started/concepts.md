...
1. [Lifecycle of a Concrete ML model](concepts.md#lifecycle-of-a-concrete-ml-model)
2. [Cryptography concepts](concepts.md#cryptography-concepts)
3. [Ciphertext formats](concepts.md#ciphertext-formats)
4. [Model accuracy considerations under FHE constraints](concepts.md#model-accuracy-considerations-under-fhe-constraints)
...
4. **Ciphertext formats** The server-side application can be configured to accept different types of ciphertexts from the client, depending on the type of application. See [Ciphertext formats](concepts.md#ciphertext-formats) for more details.
