...
The quantization of model parameters and model inputs is illustrated in the advanced examples for [Linear and Logistic Regressions](ml_examples.md). Note that different quantization parameters are used for inputs and for model weights.
