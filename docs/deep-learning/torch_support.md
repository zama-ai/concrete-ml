...
You can perform the inference on clear data in order to evaluate the impact of quantization and of FHE computation on the accuracy of their model. See [this section](fhe_assistant.md#simulation) for more details.
