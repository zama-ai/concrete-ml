...
Training this network with pruning (see [below](fhe_friendly_models.md#pruning-using-torch)) using 30 out of 100 total non-zero neurons gives good accuracy while keeping the accumulator size low.
